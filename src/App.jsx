  ...
  return (
    <div>
      ...
      <header className="main-header">
        <div className="header-container">
          ...
          <div className="header-actions">
            <button className="btn btn-secondary" onClick={() => showToast("Logged in as arabisvi@gmail.com", "shield")}>
              <Mail size={16} />
              <span>arabisvi@gmail.com</span>
            </button>
            <button className="btn btn-primary" onClick={() => document.getElementById('workspace').scrollIntoView({ behavior: 'smooth' })}>
              Try Demo
            </button>
          </div>
        </div>
      ...
      <main className="main-content">
        {/* Hero Section */}
        <section id="concept" class="hero-section">
